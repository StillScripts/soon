...
description: Write copy following professional brand guidelines. Use when writing UI text, error messages, empty states, onboarding flows, 404 pages, documentation, marketing copy, or any user-facing content. Covers both Plain Speech (default) and Brand Voice tones.
---
...
- [Professional Voice Guidelines](https://develop.sentry.dev/frontend/sentry-voice/) - Professional standards from Sentry
- [Frontend Handbook](https://develop.sentry.dev/frontend/) - Industry best practices
