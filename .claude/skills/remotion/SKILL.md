...
description: Best practices for Remotion - Video creation in React. Use this skills whenever you are dealing with Remotion code to obtain the domain-specific knowledge.
metadata:
