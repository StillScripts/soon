...
function createProcedureRegistry() {
  ...
  "create": ["mutation", typedProcedureResolver(api["things"]["create"], () => (require("../things") as Record<string, unknown>)["create"])],
  "generateUploadUrl": ["mutation", typedProcedureResolver(api["things"]["generateUploadUrl"], () => (require("../things") as Record<string, unknown>)["generateUploadUrl"])],
  "get": ["query", typedProcedureResolver(api["things"]["get"], () => (require("../things") as Record<string, unknown>)["get"])],
  "list": ["query", typedProcedureResolver(api["things"]["list"], () => (require("../things") as Record<string, unknown>)["list"])],
  "remove": ["mutation", typedProcedureResolver(api["things"]["remove"], () => (require("../things") as Record<string, unknown>)["remove"])],
  "update": ["mutation", typedProcedureResolver(api["things"]["update"], () => (require("../things") as Record<string, unknown>)["update"])],
} as const;
